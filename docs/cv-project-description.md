...
Describe the feed as “latest products” or “featured products”, not as personalized recommendation. The current application does not contain order, payment, shipping, or user-interaction data, so it should not be presented as a complete e-commerce or recommender system.
